...
/*! \file rx-retry-repeat-common.h

    \brief Implementation commonalities between retry and repeat operators abstracted away from rx-retry.h and rx-repeat.h files. Should be used only from rx-retry.h and rx-repeat.h
