...
ToggleButtonVC::ToggleButtonVC(UIRoot* root, UIElement* parent, std::shared_ptr<Observable<bool>> isOn, Image::Options offImage, Image::Options onImage, const std::string& name)
