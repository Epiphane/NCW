...
//
// DeprecatedController contains potentially multiple AnimatedSkeletons and is attached to an entity.
//
struct DeprecatedController : public Engine::Component<DeprecatedController> {
public:
   using BoneID = size_t;
